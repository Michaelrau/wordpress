...
add_action('tgmpa_register', 'dreamshop_register_required_plugins');

function dreamshop_register_required_plugins()
{
     ...
     */
    $config = array(
        'id'           => 'dreamshop',             // Unique ID for hashing notices for multiple instances of TGMPA.
